...
<head>
  <meta charset="UTF-8">
  <title>Bali Guide 2025 — EasyVisa Edition</title>
  ...
  <link rel="stylesheet" href="/css/gta-guide.css?v=3">
</head>
<body>
...
<script src="/js/bali-guide-content.js"></script>
<script>
...
function setTab(idx) {
  ...
  // Прокрутка к началу
  setTimeout(() => {
    const guideTop = document.querySelector('.gta-guide-title');
    if (guideTop) {
      guideTop.scrollIntoView({ behavior: 'smooth', block: 'start' });
    }
  }, 80);
  // Кнопки след/пред
