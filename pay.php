...
<body>
  ...
  <main class="oplata-main">
    <section class="oplata-block">
      <br>
      <div class="oplata-title" data-translate="payment.title">Оплата</div>
    </section>

    <section class="oplata-block">
      <div class="oplata-title" data-translate="trust.title">Почему нам можно доверять</div>
      <ol class="oplata-list" data-translate="trust.list">
    ...
    <section class="oplata-block">
      <div class="oplata-title" data-translate="pay_methods.title">Как можно оплатить</div>
      <ul class="oplata-pay-list" data-translate="pay_methods.list">
      ...
      <div class="oplata-info" data-translate-html="pay_methods.info">
    ...
    <section class="oplata-block cta-block">
      <div class="cta-title" data-translate="cta.title">Готовы начать?</div>
      <div class="cta-text" data-translate="cta.text">Сообщите, какой метод вам ближе — и получите счёт прямо сейчас.</div>
    </section>
  </main>
...
.payment-btn {
            background: linear-gradient(145deg, var(--gta-primary), var(--gta-secondary));
            color: #0c0c15;
            border: none;
            border-radius: 16px;
            font-size: 1.1rem;
            ...
            font-family: 'Bebas Neue', Arial, sans-serif;
            box-shadow: 0 8px 25px rgba(41, 252, 148, 0.3);
        ...
        .payment-btn:hover {
            ...
            box-shadow: 0 12px 35px rgba(41, 252, 148, 0.4);
