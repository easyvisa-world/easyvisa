...
<head>
  ...
  <script src="/include/translations.js" defer></script>
  <link rel="stylesheet" href="/css/styles-data.css?v=<?php echo time(); ?>">
...
<body>
  ...
  <div class="visa-container">
    ...
    <div class="visa-title" data-translate="visa_calculator.title">Расчёт даты выезда</div>
    <form id="visaForm" autocomplete="off">
      <div class="visa-form-grid">
        <div>
          <label class="visa-label" data-translate="visa_calculator.arrival_date">Дата прилёта</label>
          <input type="date" id="arrival-date" class="visa-input" required />
        </div>
        <div>
          <label class="visa-label" data-translate="visa_calculator.country">Страна</label>
          <select id="country" class="visa-select-data" required>
            <option value="">—</option>
            <option value="indonesia" data-translate="visa_calculator.countries.indonesia">Индонезия</option>
            <option value="thailand" data-translate="visa_calculator.countries.thailand">Таиланд</option>
            <option value="vietnam" data-translate="visa_calculator.countries.vietnam">Вьетнам</option>
          </select>
        </div>
        <div class="md:col-span-2" style="grid-column: 1 / -1;">
          <label class="visa-label" data-translate="visa_calculator.visa_type">Тип визы</label>
          <select id="visa-type" class="visa-select-data" required>
            <option value="" data-translate="visa_calculator.select_country_first">Сначала выберите страну</option>
          </select>
        </div>
      </div>
      ...
      <div class="visa-btn-row">
        <button type="button" class="visa-btn-data" onclick="calculateExitDate()">
          ...
          <span data-translate="visa_calculator.calculate">Рассчитать</span>
        </button>
        <a id="tg-remind" href="#" target="_blank" style="display:none" class="visa-btn tg">
          ...
          <span data-translate="visa_calculator.remind_telegram">Напомнить в Telegram</span>
        </a>
      </div>
      <div id="visa-hint" class="visa-hint" style="display:none" data-translate-html="visa_calculator.hint">
      ...
      <div id="result-block" class="visa-result-block" style="display:none">
        <div class="visa-result-label" data-translate="visa_calculator.result_label">Ваша последняя дата пребывания:</div>
        <div id="result-date" class="visa-result-date"></div>
      </div>
    </form>
  </div>
  <div class="visa-footer">
    <div class="visa-footer-text" data-translate="visa_calculator.need_visa_text">Нужно продлить или оформить визу? Напиши нам!</div>
