...
<head>
  ...
  <title>Виза D12 на Бали — EasyVisa | Оформление и продление за 1 час</title>
  <meta name="description" content="Оформите или продлите визу D12 на Бали всего за $499. Бесплатная бронь обратного билета, оформление онлайн за 1 час, поддержка 24/7.">
  ...
  <meta property="og:title" content="Виза D12 на Бали — EasyVisa | Оформление и продление за 1 час">
  <meta property="og:description" content="Оформите или продлите визу D12 на Бали всего за $499. Бесплатная бронь обратного билета, оформление онлайн за 1 час, поддержка 24/7.">
  ...
  <meta name="twitter:title" content="Виза D12 на Бали — EasyVisa | Оформление и продление за 1 час">
  <meta name="twitter:description" content="Оформите или продлите визу D12 на Бали всего за $499. Бесплатная бронь обратного билета, оформление онлайн за 1 час, поддержка 24/7.">
  <meta name="twitter:image" content="https://easyvisa.world/wp-content/uploads/2023/12/logo2.svg_.svg">
  <script src="https://cdn.tailwindcss.com"></script>
  <style>
    body { background: #0f172a; color: #fff; font-family: 'Segoe UI', sans-serif; padding: 1rem;}
    .logo-top {
      display: flex;
    ...
    .main-footer-cta { margin: 3.2em auto 0 auto; max-width: 540px; padding: 1.1em 1.2em 1.15em 1.2em; border-radius: 1.1em;
      background: linear-gradient(120deg, rgba(20,184,166,0.13), rgba(30,41,59,0.94) 88%);
      box-shadow: 0 0 24px 2px #14b8a6b0, 0 0 2px #14b8a6 inset; display: flex; flex-direction: column; align-items: center;}
...
<div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">Виза D12 — 1 год</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Долгосрочная виза для бизнеса и фриланса. Без постоянных визаранов.
        </div>
      </div>
      <div class="flex items-end justify-between mt-2">
        ...
        <div class="flex flex-col items-end">
          <div class="bg-[#15181d] border-2 border-[#ffe95d] px-7 py-3 rounded-xl flex items-baseline gap-2 shadow-[0_0_12px_#ffe95dbb]">
            <span class="text-3xl text-[#ffe95d] font-extrabold font-gta drop-shadow-[0_0_7px_#ffe95da1]">$499</span>
      ...
      <div id="gta-tooltip"
        ...
        180 + 180 дней, можно перейти на KITAS Investor без вылета.
      </div>
    </div>
    <!-- КНОПКИ -->
...
<br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">D12 — твой новый уровень жизни на Бали за $499</h2>
      <p>Виза закончилась — и что дальше? Билеты на визаран дорожают, планируешь вылет за границу, теряешь дни отпуска и деньги.
D12 — это свобода жить 180 дней подряд без нервов, бюрократии и беготни по агентам. Не надо продлевать визу каждый месяц, не надо думать об обратном билете, не надо бояться контроля. Это виза для тех, кто не готов жить “на чемоданах”. D12 — годовая виза: 180 дней живёшь без визаранов, потом один вылет — и ещё 180 дней спокойно. Не нужно собирать справки, не нужно объяснять, зачем ты здесь. Всё официально, быстро и без лишних вопросов.</p>
    </div>
    <div class="card" data-modal="2">
      <span class="number">2</span>
      <h2 class="text-lg font-semibold mb-1">Что входит?</h2>
      <p>
        <span style="font-size:1.3em;">✅</span> Официальная годовая виза D12<br>
        <span style="font-size:1.3em;">✅</span> Оформление $499, без вылета $649 (если ты уже на острове)<br>
        <span style="font-size:1.3em;">✅</span> Всё делаем онлайн, все документы под ключ<br>
        <span style="font-size:1.3em;">✅</span> Всё полностью онлайн, никаких скрытых платежей
      </p>
    </div>
    <div class="card" data-modal="3">
      ...
      <p>
        ...
        2. Отправь фото паспорта, селфи и банковскую выписку (любая сумма, любая валюта)<br>
        3. Ты оплачиваешь, мы подготавливаем приглашение и необходимые документы<br>
        4. Виза оформляется онлайн, срок оформления 3-5 рабочих дней<br>
        5. К оплате принимаем: IDR/MYR/VND/RUB/EUR/USDT
      </p>
    </div>
    <div class="card" data-modal="4">
      ...
      <p>
        — Страшно просрочить визу? С D12 такого не будет — у тебя 180 дней, и ты знаешь дату “до секунды”<br>
        — Не хочется платить за KITAS? D12 дешевле и проще, а по сроку почти не уступает<br>
        — Мы официальное агентство, все документы проходят проверку в миграционной службе<br>
        — Уже на острове? Не надо вылетать — оформим без визарана, просто присылай документы.
      </p>
    </div>
    <div class="card" data-modal="5">
      <span class="number">5</span>
      <h2 class="text-lg font-semibold mb-1">Готовы начать?</h2>
      <p>Уже больше 4000 человек прошли через автогейт с нашей визой и забыли про очереди.
Пиши нам сейчас — и твой отпуск начнётся без нервов уже в аэропорту. Оформи B1 заранее и почувствуй себя VIP — быстрый проход, никаких вопросов, только удовольствие.</p>
    </div>
  </div>
    ...
    const modalContent = [
      {
        ...
        text: "Оформление визы D12 — быстро, онлайн, без лишней суеты. Напиши нам и мы всё расскажем."
      },
      {
        title: "Связаться с нами",
        text: "Получите бесплатную бронь, сопровождение и напоминания о продлении. Поддержка 24/7!"
      },
      {
        title: "Связаться с нами",
        text: "Отправь фото паспорта и дату прилета — и получи визу уже сегодня."
      },
      {
        title: "Связаться с нами",
        text: "Ответим на любые вопросы про продление, оформление, документы и жизнь на Бали."
      },
      {
        title: "Связаться с нами",
        text: "Ты в хорошей компании — доверь визу экспертам EasyVisa."
      }
    ];
