...
<head>
  ...
  <title>DTV — Digital Nomad виза в Таиланд | EasyVisa | 5 лет легального пребывания</title>
  <meta name="description" content="Оформи визу DTV на 5 лет в Таиланд. Живи без визаранов и стресса. Только паспорт, селфи и выписка.">
  <link rel="icon" href="https://easyvisa.world/wp-content/uploads/2023/12/logo2.svg_.svg">
  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://easyvisa.world/dtv">
  <meta property="og:title" content="DTV виза Таиланд — EasyVisa | 5 лет без визаранов и вылетов">
  <meta property="og:description" content="Digital Nomad виза в Таиланд на 5 лет. Без визаранов, всё официально. Только паспорт, селфи и банковская выписка.">
  ...
  <meta name="twitter:title" content="DTV виза Таиланд — EasyVisa | Живи без стресса 5 лет">
  <meta name="twitter:description" content="Легальный статус в Таиланде. Без гонки по аэропортам, без депортации. Только паспорт, селфи и выписка.">
...
<div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">DTV Digital Nomad — 5 лет</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Долгосрочная цифровая виза для работы и жизни в Таиланде, для IT-специалистов и удалёнщиков.
        </div>
      </div>
      <div class="flex items-end justify-between mt-2">
        ...
        <div class="flex flex-col items-end">
          <div class="bg-[#15181d] border-2 border-[#ffe95d] px-7 py-3 rounded-xl flex items-baseline gap-2 shadow-[0_0_12px_#ffe95dbb]">
            <span class="text-3xl text-[#ffe95d] font-extrabold font-gta drop-shadow-[0_0_7px_#ffe95da1]">$650</span>
      ...
      <div id="gta-tooltip"
        ...
        Позволяет проживать и работать с семьёй.
      </div>
    </div>
    <!-- КНОПКИ -->
...
<br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">DTV — легальная виза digital nomad в Таиланд на 5 лет</h2>
      <p>Устал каждый месяц искать новую визу, бояться просрочки, летать на визаран и жить "на чемоданах"? DTV — это твой легальный статус в Таиланде: 5 лет визы, год без вылетов, никакой гонки по аэропортам и рисков депортации. DTV — новая реальность: статус digital nomad, легальный контракт, спокойная жизнь в Тае хоть пять лет подряд.</p>
    </div>
    <div class="card" data-modal="2">
      <span class="number">2</span>
      <h2 class="text-lg font-semibold mb-1">Что входит?</h2>
      <p>
        <span style="font-size:1.3em;">✅</span> Официальная digital nomad-виза на 5 лет<br>
        <span style="font-size:1.3em;">✅</span> Без визаранов — 1 год подряд, продление ежегодно<br>
        <span style="font-size:1.3em;">✅</span> Оформление всех документов и контракта<br>
        <span style="font-size:1.3em;">✅</span> Только фото паспорта, селфи и банковская выписка<br>
        <span style="font-size:1.3em;">✅</span> Срок оформления: 10–14 рабочих дней
      </p>
    </div>
    <div class="card" data-modal="3">
      ...
      <p>
        1. Пиши нам в Telegram: <strong><a href="https://t.me/evisa_support">@evisa_support</a></strong><br>
        2. Отправь фото паспорта, селфи и банковскую выписку (любая валюта, сумма не важна)<br>
        3. Мы подготавливаем рабочий контракт и подаём документы<br>
        4. Оплачиваешь $650 — всё включено, без скрытых платежей<br>
        5. Через 10–14 рабочих дней получаешь визу на email
      </p>
    </div>
    <div class="card" data-modal="4">
      ...
      <p>
        — Можно ли работать по DTV? Нет, это digital nomad-виза с контрактом за границей<br>
        — Сложно ли подать? Нет, всё под ключ, только фото, селфи и выписка<br>
        — А если откажут? Мы проверяем всё заранее, отказы исключены<br>
        — Нужен ли тайский работодатель? Нет<br>
        — DTV — это стабильность, долгий срок и честная легальность
      </p>
    </div>
    <div class="card" data-modal="5">
      <span class="number">5</span>
      <h2 class="text-lg font-semibold mb-1">Готовы начать?</h2>
      <p>Оформи DTV и забудь о визаранах, гонке по аэропортам и рисках депортации. Один раз реши визовый вопрос на 5 лет вперёд — и живи, как мечтал. DTV — это не "хитрость", это честная жизнь в любимой стране. Пиши нам и начнём оформление уже сегодня.</p>
    </div>
  </div>
  <div id="modal-root"></div>
  <footer class="main-footer-cta">
    <div class="footer-title">Готовы оформить DTV визу?</div>
  ...
  <script>
    const modalContent = [
      {
        title: "Живи без визаранов",
        text: "DTV — это 5 лет легального статуса, без вылетов, без стресса. Только честная, официальная виза."
      },
      {
        title: "Что входит?",
        text: "Digital nomad-виза на 5 лет, с контрактом и всеми документами. Без скрытых платежей."
      },
      {
        title: "Как подать?",
        text: "Паспорт, селфи, выписка. Всё остальное — на нас. Оформим онлайн, без визита в офис."
      },
      {
        title: "Всё под контролем",
        text: "Отказы исключены. Мы проверяем документы до подачи и работаем по госстандартам."
      },
      {
        title: "Пора начать",
        text: "DTV — это жизнь в Тае без беготни. Пиши нам — и забудь про визовые стрессы на годы вперёд."
      }
    ];
