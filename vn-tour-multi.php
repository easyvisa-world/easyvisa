...
<head>
  ...
  <title>Мультивиза во Вьетнам — EasyVisa | 90 дней, $90, без ограничений</title>
  <meta name="description" content="Мультивиза во Вьетнам на 90 дней за $90. Неограниченное количество въездов и выездов. Только паспорт и селфи.">
  <link rel="icon" href="https://easyvisa.world/wp-content/uploads/2023/12/logo2.svg_.svg">
  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://easyvisa.world/vietnam90multi">
  <meta property="og:title" content="Мультивиза во Вьетнам — EasyVisa | 90 дней, $90, без ограничений">
  <meta property="og:description" content="Въезжай и выезжай сколько хочешь. Туристическая мультивиза на 90 дней, оформление за 3-4 дня, цена $90.">
  ...
  <meta name="twitter:title" content="Мультивиза во Вьетнам на 90 дней — EasyVisa | Оформление онлайн за $90">
  <meta name="twitter:description" content="Мультивиза без ограничений на въезд/выезд в течение 90 дней. Только паспорт и селфи.">
...
<div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">Вьетнам E-visa Multi — 90 дней</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Многократный въезд на 3 месяца, подходит для путешествий по ЮВА.
        </div>
      </div>
      <div class="flex items-end justify-between mt-2">
        ...
        <div class="flex flex-col items-end">
          <div class="bg-[#15181d] border-2 border-[#ffe95d] px-7 py-3 rounded-xl flex items-baseline gap-2 shadow-[0_0_12px_#ffe95dbb]">
            <span class="text-3xl text-[#ffe95d] font-extrabold font-gta drop-shadow-[0_0_7px_#ffe95da1]">$90</span>
      ...
      <div id="gta-tooltip"
        ...
        Можно въезжать и выезжать неограниченно в течение срока.
      </div>
    </div>
    <!-- КНОПКИ -->
...
<br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">Мультивиза во Вьетнам — 90 дней свободы за $90</h2>
      <p>Обычная виза — это один въезд. Мультивиза даёт тебе свободу: заезжай и выезжай сколько хочешь в течение 90 дней. Вьетнам, Таиланд, снова Вьетнам — никаких новых заявок и рисков отказа. Только комфортное путешествие.</p>
    </div>
    <div class="card" data-modal="2">
      <span class="number">2</span>
      <h2 class="text-lg font-semibold mb-1">Что входит?</h2>
      <p>
        <span style="font-size:1.3em;">✅</span> Официальная туристическая мультивиза на 90 дней<br>
        <span style="font-size:1.3em;">✅</span> Безлимитный въезд и выезд в течение срока<br>
        ...
        <span style="font-size:1.3em;">✅</span> Фиксированная цена $90, всё включено
      </p>
    </div>
    <div class="card" data-modal="3">
      ...
      <p>
        ...
        3. Оплачиваешь $90 — визовый сбор уже включён<br>
        4. Через 3–4 дня получаешь визу на email<br>
        5. Въезжай и выезжай сколько угодно в течение срока действия
      </p>
    </div>
    <div class="card" data-modal="4">
      ...
      <p>
        — Сколько раз можно въезжать? Без ограничений, пока действует виза<br>
        — Это сложно? Нет, только паспорт и селфи<br>
        — Нужно ли что-то ещё? Нет, мы всё сделаем<br>
        — Сколько стоит? $90 — без скрытых платежей<br>
        — Где бы ты ни пересекал границу — виза работает
      </p>
    </div>
  ...
  <footer class="main-footer-cta">
    <div class="footer-title">Готовы оформить мультивизу?</div>
    ...
    const modalContent = [
      {
        ...
        text: "Мультивиза на 90 дней за $90 — въезжай и выезжай, когда хочешь. Без лимитов."
      },
      {
        title: "Просто и надёжно",
        text: "Только паспорт и селфи. Без анкет, отказов, лишних бумаг. Оформим за тебя."
      },
      {
        title: "Как подать?",
        text: "Пиши в Telegram, отправь фото — и получи визу на почту за 3–4 дня."
      },
      {
        title: "Никаких скрытых условий",
        text: "Всё официально. Цена $90 включает всё. Никаких дополнительных платежей."
      },
      {
        title: "Пора в путь",
        text: "Планируй маршрут, не думая о визе. Мы всё оформим — ты просто путешествуй."
      }
    ];
