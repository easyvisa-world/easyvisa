...
<head>
  ...
  <title>Виза E33G на Бали — EasyVisa | Оформление и продление </title>
  <meta name="description" content="Оформите или продлите KITAS E33G на Бали всего за $990. Все документы под ключ, оформление онлайн, поддержка 24/7.">
  ...
  <meta property="og:title" content="KITAS E33G на Бали — EasyVisa | Оформление и продление">
  <meta property="og:description" content="Оформите или продлите визу E33G на Бали всего за $990. Бесплатная бронь обратного билета, оформление онлайн, поддержка 24/7.">
  ...
  <meta name="twitter:description" content="Оформите или продлите визу D12 на Бали всего за $499. Бесплатная бронь обратного билета, оформление онлайн, поддержка 24/7.">
...
<div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">KITAS E33G — 1 год</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Официальная виза удаленного работника. Открывает доступ к банковским счетам, аренде и страховкам.
        </div>
      </div>
      <div class="flex items-end justify-between mt-2">
        ...
        <div class="flex flex-col items-end">
          <div class="bg-[#15181d] border-2 border-[#ffe95d] px-7 py-3 rounded-xl flex items-baseline gap-2 shadow-[0_0_12px_#ffe95dbb]">
            <span class="text-3xl text-[#ffe95d] font-extrabold font-gta drop-shadow-[0_0_7px_#ffe95da1]">$990</span>
      ...
      <div id="gta-tooltip"
        ...
        Мы предоставляем контракт на работу, для оформления KITAS.
      </div>
    </div>
    <!-- КНОПКИ -->
...
<br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">E33G — KITAS удаленного работника за $990</h2>
      <p>Ты устал жить “на птичьих правах”? С E33G твой статус на Бали подтверждён официально — ты можешь спокойно работать, запускать бизнес, оформлять банковские счета и забыть о риске депортации за подработку “на туристе”. 
      E33G оформляется один раз на год — больше не волнуешься о продлениях, штампах и “подозрительных” вопросах на границе.    </div>
    <div class="card" data-modal="2">
      <span class="number">2</span>
      <h2 class="text-lg font-semibold mb-1">Что входит?</h2>
      <p>
        <span style="font-size:1.3em;">✅</span> Официальное резиденство на 1 год<br>
        <span style="font-size:1.3em;">✅</span> Оформление $990 без вылета $1140 (если ты уже на острове)<br>
        <span style="font-size:1.3em;">✅</span> Без визитов в консульство, все документы под ключ<br>
    ...
    <div class="card" data-modal="3">
      ...
      <p>
        ...
        4. Виза оформляется онлайн, срок оформления 7-10 рабочих дней<br>
    ...
    <div class="card" data-modal="4">
      ...
      <p>
        — Страшно просрочить визу? С E33G такого не будет — у тебя впереди целый год<br>
        — Безопасно ли это? Да, мы оформляем для вас рабочий контракт с нашей компанией в ОАЭ<br>
...
Пиши нам сейчас — и твой отпуск начнётся без нервов уже в аэропорту. Оформи KITAS E33G и почувствуй себя VIP — быстрый проход, никаких вопросов, только удовольствие.</p>
    </div>
  </div>
    ...
    const modalContent = [
      {
        ...
        text: "Оформление визы E33G — быстро, онлайн, без лишней суеты. Напиши нам и мы всё расскажем."
      },
      {
        title: "Связаться с нами",
