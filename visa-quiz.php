...
<head>
  ...
  <style>
    body { 
      margin: 0; padding: 0; color: #fff; font-family: 'Russo One', Arial, sans-serif; padding-top: 80px; overflow-x: hidden; 
    }
    ...
    @media (max-width: 600px) { 
      ...
      .quiz-container { max-width: 99vw; padding: 1.1rem 0.4rem 1.8rem 0.4rem; margin: 1.5rem auto; }
    ...
    .quiz-nav { display: flex; gap: 1rem; margin-top: 1.5rem; justify-content: center;}
    .quiz-nav-btn { 
