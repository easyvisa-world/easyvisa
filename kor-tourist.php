...
<head>
  ...
  <title>Виза в Южную Корею — EasyVisa | Онлайн оформление за $120</title>
  <meta name="description" content="Туристическая виза в Южную Корею на 90 дней. Всё официально. Только паспорт и селфи. Стоимость — $120.">
  <link rel="icon" href="https://easyvisa.world/wp-content/uploads/2023/12/logo2.svg_.svg">
  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://easyvisa.world/korea">
  <meta property="og:title" content="Виза в Южную Корею — EasyVisa | 90 дней без бюрократии">
  <meta property="og:description" content="Онлайн оформление визы в Южную Корею на 90 дней. Без визита в консульство. Только фото паспорта и селфи.">
  ...
  <meta name="twitter:title" content="Виза в Южную Корею — EasyVisa | $120, 3–5 дней, всё включено">
  <meta name="twitter:description" content="Оформим визу за вас. Только паспорт и селфи. Всё официально. Поддержка на русском.">
...
<div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">Виза Южная Корея — 90 дней</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Туристическая виза на 3 месяца. Быстрое и простое оформление, без личного визита в консульство.
        </div>
      </div>
      <div class="flex items-end justify-between mt-2">
        ...
        <div class="flex flex-col items-end">
          <div class="bg-[#15181d] border-2 border-[#ffe95d] px-7 py-3 rounded-xl flex items-baseline gap-2 shadow-[0_0_12px_#ffe95dbb]">
            <span class="text-3xl text-[#ffe95d] font-extrabold font-gta drop-shadow-[0_0_7px_#ffe95da1]">$120</span>
      ...
      <div id="gta-tooltip"
        ...
        Можно продлить на месте по согласованию с миграционной службой.
      </div>
    </div>
    <!-- КНОПКИ -->
...
<br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">Южная Корея — туристическая виза за $120</h2>
      <p>Южная Корея славится строгими требованиями: ошибка — почти гарантированный отказ. Вместо недель на разбор анкет и рисков — просто пришли фото паспорта и селфи, остальное мы берём на себя. Весь процесс онлайн, всё официально, никаких лишних шагов.</p>
    </div>
    <div class="card" data-modal="2">
      <span class="number">2</span>
      <h2 class="text-lg font-semibold mb-1">Что входит?</h2>
      <p>
        <span style="font-size:1.3em;">✅</span> Туристическая виза в Южную Корею на 90 дней<br>
        <span style="font-size:1.3em;">✅</span> Только фото паспорта и селфи<br>
        <span style="font-size:1.3em;">✅</span> Оформление онлайн, без консульства<br>
        <span style="font-size:1.3em;">✅</span> Срок оформления — 3–5 дней<br>
        <span style="font-size:1.3em;">✅</span> Стоимость — $120, всё включено
      </p>
    </div>
    <div class="card" data-modal="3">
      ...
      <p>
        1. Напиши в Telegram: <strong><a href="https://t.me/evisa_support">@evisa_support</a></strong><br>
        2. Отправь фото паспорта и селфи<br>
        3. Оплати $120 — мы сразу подаём документы<br>
        4. Ждёшь подтверждение (5–7 рабочих дней)<br>
        5. Виза приходит на email — распечатай и покажи на границе
      </p>
    </div>
    <div class="card" data-modal="4">
      ...
      <p>
        — Нужно ли что-то ещё? Только паспорт и селфи<br>
        — Это официально? Да, виза проходит проверку на границе<br>
        — Сколько платить? $120, всё включено<br>
        — А если я не из России? Мы работаем со всеми странами СНГ<br>
        — Надо знать корейский? Нет, мы всё оформляем на русском
      </p>
    </div>
    <div class="card" data-modal="5">
      <span class="number">5</span>
      <h2 class="text-lg font-semibold mb-1">Готовы начать?</h2>
      <p>Хватит бояться анкет и отказов. Мы оформим визу в Южную Корею за тебя — быстро, официально и на русском языке. Присылай фото, оплати $120 — и через несколько дней виза будет у тебя. Всё просто.</p>
    </div>
  </div>
  ...
  <script>
    const modalContent = [
      {
        title: "Виза без отказа",
        text: "Южная Корея — это строго. Но мы всё делаем правильно. Только фото — и виза готова."
      },
      {
        title: "Полностью онлайн",
        text: "Визит в консульство не нужен. Всё оформим удалённо, поддержим на каждом шаге."
      },
      {
        title: "Как подать?",
        text: "Фото паспорта и селфи, оплата $120 — и мы всё делаем сами. Через 5–7 дней виза у тебя."
      },
      {
        title: "Поддержка на русском",
        text: "Не нужен английский или корейский. Всё оформим на русском, объясним и проверим."
      },
      {
        title: "Ждём тебя",
        text: "Оформи визу заранее — и поезжай в Корею без бюрократии. Мы всё сделаем."
      }
    ];
