...
<head>
  ...
  <title>Виза во Вьетнам на 90 дней — EasyVisa | Оформление онлайн за $50</title>
  <meta name="description" content="Туристическая виза во Вьетнам на 90 дней за $50. Только фото паспорта и селфи. Без отказов, всё официально.">
  <link rel="icon" href="https://easyvisa.world/wp-content/uploads/2023/12/logo2.svg_.svg">
  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://easyvisa.world/vietnam90">
  <meta property="og:title" content="Виза во Вьетнам на 90 дней — EasyVisa | Оформление онлайн за $50">
  <meta property="og:description" content="Без анкет, риска отказа и скрытых платежей. Только фото паспорта и селфи — остальное мы сделаем сами.">
  ...
  <meta name="twitter:title" content="Виза во Вьетнам на 90 дней — EasyVisa | Без отказов, быстро, $50">
  <meta name="twitter:description" content="Оформление туристической визы во Вьетнам за $50. Подходит всем. Срок — 3-4 дня.">
...
<div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">Вьетнам Single — 90 дней</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Однократная виза на 90 дней. Быстрое оформление, подходит для визарана и отдыха.
        </div>
      </div>
      ...
      <div id="gta-tooltip"
        ...
        Виза подходит для визарана и проживания.
      </div>
    </div>
    <!-- КНОПКИ -->
...
<br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">Туристическая виза во Вьетнам за $50 — просто и без ошибок</h2>
      <p>Сколько людей потратили часы, чтобы заполнить непонятные анкеты, получить ошибку оплаты или нарваться на посредников? Забудь про анкеты, странные сайты и риск получить отказ. Мы оформим тебе официальную туристическую визу на 90 дней за $50 — быстро, без лишних шагов. Только паспорт и селфи — всё остальное сделаем мы.</p>
    </div>
    <div class="card" data-modal="2">
      <span class="number">2</span>
      <h2 class="text-lg font-semibold mb-1">Что входит?</h2>
      <p>
        <span style="font-size:1.3em;">✅</span> 90 дней во Вьетнаме — однократный въезд<br>
        <span style="font-size:1.3em;">✅</span> Только фото паспорта и селфи<br>
        <span style="font-size:1.3em;">✅</span> Визовый сбор включён в стоимость<br>
        <span style="font-size:1.3em;">✅</span> Оформление за 3–4 рабочих дня
      </p>
    </div>
    <div class="card" data-modal="3">
      ...
      <p>
        ...
        3. Оплачиваешь $50 — визовый сбор уже включён<br>
        4. Через 3–4 дня получаешь визу на почту<br>
        5. Показываешь с телефона на границе — и всё!
      </p>
    </div>
    <div class="card" data-modal="4">
      ...
      <p>
        — Это точно сработает? Да. Мы оформляем только через официальные каналы<br>
        — А если что-то не так с фото? Мы проверим и подскажем<br>
        — Точно никаких доплат? Да, только $50, всё включено<br>
        — Как быстро? Обычно 3–4 рабочих дня — и виза у тебя
      </p>
    </div>
    <div class="card" data-modal="5">
      <span class="number">5</span>
      <h2 class="text-lg font-semibold mb-1">Готовы начать?</h2>
      <p>Сотни клиентов уже получили визу через нас — никаких отказов, всё официально. Всё, что нужно — паспорт и селфи. Не откладывай поездку: пиши нам и начни собирать чемодан!</p>
    </div>
  </div>
  ...
  <script>
    const modalContent = [
      {
        title: "Оформим за тебя",
        text: "Туристическая виза на 90 дней во Вьетнам за $50. Только фото и селфи — остальное на нас."
      },
      {
        title: "Быстро и без рисков",
        text: "Мы работаем только с официальными визовыми каналами. Никаких отказов, всё прозрачно."
      },
      {
        title: "Процесс простой",
        text: "Фото паспорта, селфи и $50 — и через 3–4 дня у тебя готовая виза в телефоне."
      },
      {
        title: "Есть вопросы?",
        text: "Наши менеджеры помогут, проверят фото и всё расскажут. Мы на связи 24/7."
      },
      {
        title: "Поехали!",
        text: "Вьетнам ждёт! Пиши нам — и забудь про бумажки. Всё легко, быстро, надёжно."
      }
    ];
