...
<body>
  ...
  <main class="about-main">
    <section class="about-hero">
      <br>
      <div class="about-title" data-translate="about.title">EasyVisa World Agency IBC №4875283</div>
      <div class="about-subtitle" data-translate="about.subtitle">
      ...
      <div class="about-bullets">
        <ul data-translate="about.bullets">
    ...
    <section class="about-contacts">
      <div class="contacts-title" data-translate="about.contacts_title">Где находимся</div>
      <ul class="contacts-list" data-translate="about.contacts_list">
    ...
    <section class="about-story">
      <div class="about-story-text" data-translate="about.story_text">
    ...
    <section class="about-table-section">
      <div class="table-title" data-translate="about.table_title">Частые проблемы и наш подход к решению</div>
      <div class="about-table">
        <div class="about-table-row">
          <div class="about-table-cell bold" data-translate="about.table_header1">Боль клиента</div>
          <div class="about-table-cell bold" data-translate="about.table_header2">Наш контр-подход</div>
        </div>
        <div class="about-table-row">
          <div class="about-table-cell" data-translate="about.table_cell1">Скрытые комиссии (52% отзывов)</div>
          <div class="about-table-cell" data-translate="about.table_cell2">«Всё включено» — финальная цена с визовым сбором, без доплат.</div>
        </div>
        <div class="about-table-row">
          <div class="about-table-cell" data-translate="about.table_cell3">Неразбериха со статусом (37%)</div>
          <div class="about-table-cell" data-translate="about.table_cell4">Личный трекер в Telegram: уведомления о каждом шаге 24/7.</div>
        </div>
        <div class="about-table-row">
          <div class="about-table-cell" data-translate="about.table_cell5">Задержки и молчание агентств (34%)</div>
          <div class="about-table-cell" data-translate="about.table_cell6">SLA-ответа ≤30 минут, договорная пеня за срок &gt;5 раб. дней.</div>
        </div>
        <div class="about-table-row">
          <div class="about-table-cell" data-translate="about.table_cell7">Ошибки в документах (23%)</div>
          <div class="about-table-cell" data-translate="about.table_cell8">Двойная проверка юрист+AI-скан; покрываем штрафы за наш счёт.</div>
        </div>
        <div class="about-table-row">
          <div class="about-table-cell" data-translate="about.table_cell9">Отсутствие помощи после выдачи визы (19%)</div>
          <div class="about-table-cell" data-translate="about.table_cell10">Post-Visa Care: помощь в открытии счетов, страховке, продлении.</div>
        </div>
      </div>
    </section>

    <section class="about-values">
      <div class="values-title" data-translate="about.values_title">Наши ценности</div>
      <ol data-translate="about.values_list">
      ...
      <div class="about-mission" data-translate="about.mission">Наша цель — делать международные переезды такими же простыми, как бронирование авиабилета.</div>
    </section>
  </main>
