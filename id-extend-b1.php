 ...
 <div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">Продление B1 — 30 дней</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Оформление без выезда, полностью онлайн за 1 день. Гарантия легальности.
        </div>
      </div>
      <div class="flex items-end justify-between mt-2">
        ...
        <div class="flex flex-col items-end">
          <div class="bg-[#15181d] border-2 border-[#ffe95d] px-7 py-3 rounded-xl flex items-baseline gap-2 shadow-[0_0_12px_#ffe95dbb]">
            <span class="text-3xl text-[#ffe95d] font-extrabold font-gta drop-shadow-[0_0_7px_#ffe95da1]">$59</span>
      ...
      <div id="gta-tooltip"
        ...
        Можно продлить ещё на 30 дней —<br>
        <span class="text-[#29fc94] font-extrabold">до 60 дней в сумме</span>
      </div>
    </div>
    <!-- КНОПКИ -->
 ...
 <br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">Продление визы B1 за $59</h2>
      <p>Виза подходит к концу? Не хочется никуда улетать, дергаться, терять деньги на билетах и нервах?
Продление B1 — это шанс остаться легально на Бали ещё на месяц, не меняя ритм жизни и не переживая из-за статуса. Продлим B1 за 1 день, без очередей, без визарана и штрафов.
Забудь про иммиграцию — наслаждайся островом.</p>
    </div>
    <div class="card" data-modal="2">
      <span class="number">2</span>
      <h2 class="text-lg font-semibold mb-1">Что входит?</h2>
      <p>
        <span style="font-size:1.3em;">✅</span> Онлайн-оформление за 1 день<br>
        <span style="font-size:1.3em;">✅</span> Бесплатная бронь обратного билета<br>
        <span style="font-size:1.3em;">✅</span> Полное сопровождение: поддержка на русском, отвечаем на все вопросы<br>
        <span style="font-size:1.3em;">✅</span> Не нужно сдавать паспорт — всё решается оформляется онлайн
      </p>
    </div>
    <div class="card" data-modal="3">
      ...
      <p>
        ...
        2. Отправь фото паспорта, селфи и оплату<br>
        3. В теч. 2 рабочих дней будет назначена сдача биометрии<br>
        4. Просто сдаешь отпечатки и делаешь фото в миграционной<br>
        5. ПЛАТИТЬ В МИГРАЦИОННОЙ БОЛЬШЕ НЕ НУЖНО, ВСЕ ОПЛАЧЕНО ЗАРАНЕЕ<br>
        6. К оплате принимаем: IDR/MYR/VND/RUB/EUR/USDT 
      </p>
    </div>
    <div class="card" data-modal="4">
      ...
      <p>
        — Не хочешь делать визаран? Не надо, продлим онлайн<br>
        — А вдруг обман? Уже 4000+ клиентов продлили визу через нас, есть отзывы и кейсы<br>
        — Мы официальное агентство, все документы проходят проверку в миграционной службе<br>
        — Боишься просрочить? Мы берем все риски на себя и гарантируем продление вовремя
      </p>
    </div>
    <div class="card" data-modal="5">
      <span class="number">5</span>
      <h2 class="text-lg font-semibold mb-1">Готовы начать?</h2>
      <p>Больше 4000 человек уже оформили B1 через нас — без штрафов, очередей и вылетов.
Не рискуй своим спокойствием — останься на Бали легально. Не трать нервы на поиски агентов и непонятные чаты.
Просто напиши нам — и забудь о визовых проблемах.</p>
    </div>
  </div>
    ...
    const modalContent = [
      {
        ...
        text: "Оформление визы B1 — быстро, онлайн, без лишней суеты. Напиши нам и мы всё расскажем."
      },
      {
        title: "Связаться с нами",
