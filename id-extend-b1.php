...
<head>
  ...
  <link rel="alternate" hreflang="en" href="https://easyvisa.world/en/b1-extension">
  ...
  <script type="application/ld+json">
  {
    ...
    "offers": {
      ...
      "price": "59",
      "priceCurrency": "USD",
      "url": "https://easyvisa.world/b1-extension",
...
<main>
  <div class="service-container">
    ...
    <section class="steps-section">
      <h2 class="section-title">Как продлить визу B1</h2>
      ...
      <div class="steps-grid">
        ...
        <div class="step-card">
          ...
          <div class="step-content">
            <p>- Не хочешь делать визаран? Не надо, продлим онлайн.</p>
            <p>- А вдруг обман? Уже 4000+ клиентов продлили визу через нас, есть отзывы и кейсы.</p>
            <p>- Мы официальное агентство: все документы проходят проверку в миграционной службе.</p>
            <p>- Боишься просрочить? Мы берём все риски на себя и гарантируем продление вовремя.</p>
          </div>
        </div>
