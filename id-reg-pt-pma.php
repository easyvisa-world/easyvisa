...
<head>
  ...
  <title>Регистрация PT PMA в Индонезии — EasyVisa | Легальный бизнес за $1600</title>
  <meta name="description" content="Полная регистрация PT PMA онлайн за $1600. Включает открытие счёта, виртуальный офис и налоговый номер.">
  <link rel="icon" href="https://easyvisa.world/wp-content/uploads/2023/12/logo2.svg_.svg">
  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://easyvisa.world/ptpma">
  <meta property="og:title" content="Регистрация PT PMA в Индонезии — EasyVisa | Легальный бизнес за $1600">
  <meta property="og:description" content="Регистрация PT PMA под ключ: счёт, офис, NPWP. Легально, онлайн, без посредников.">
  ...
  <meta name="twitter:title" content="Регистрация PT PMA в Индонезии — EasyVisa | Онлайн оформление за $1600">
  <meta name="twitter:description" content="Легально владей бизнесом в Индонезии: регистрация PT PMA за $1600. Полное сопровождение, онлайн.">
...
<div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">Регистрация компании (PT PMA)</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Комплексное сопровождение, все этапы «под ключ», банковский счет, легальная работа на Бали.
        </div>
      </div>
      <div class="flex items-end justify-between mt-2">
        ...
        <div class="flex flex-col items-end">
          <div class="bg-[#15181d] border-2 border-[#ffe95d] px-7 py-3 rounded-xl flex items-baseline gap-2 shadow-[0_0_12px_#ffe95dbb]">
            <span class="text-3xl text-[#ffe95d] font-extrabold font-gta drop-shadow-[0_0_7px_#ffe95da1]">$1600</span>
      ...
      <div id="gta-tooltip"
        ...
        Открываем счет и KITAS владельцу.
      </div>
    </div>
    <!-- КНОПКИ -->
...
<br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">PT PMA — легальный старт бизнеса в Индонезии за $1600</h2>
    ...
    <div class="card" data-modal="2">
      ...
      <p>
        <span style="font-size:1.3em;">✅</span> Официальная регистрация PT PMA онлайн<br>
        <span style="font-size:1.3em;">✅</span> Виртуальный офис для госорганов и банков<br>
        <span style="font-size:1.3em;">✅</span> Открытие счёта в индонезийском банке<br>
        <span style="font-size:1.3em;">✅</span> NPWP — налоговый номер для бизнеса<br>
        <span style="font-size:1.3em;">✅</span> Консультации по налогам, найму и KITAS
      </p>
    </div>
    <div class="card" data-modal="3">
      ...
      <p>
        ...
        2. Отправь фото паспорта, селфи и ИНН своей страны<br>
        3. Мы создаём виртуальный офис и подаём заявку<br>
        4. После одобрения регистрируем NPWP и открываем счёт<br>
        5. Все документы и доступы получаешь онлайн
      </p>
    </div>
    <div class="card" data-modal="4">
      ...
      <p>
        — Это фиктивная компания? Нет, ты 100% владелец<br>
        — Нужен ли визит на Бали? Нет, всё онлайн<br>
        — Можно ли получить KITAS? Да, PT PMA — это основа<br>
        — Сколько ждать? Обычно 30–40 рабочих дней<br>
        — Всё через госорганы, без посредников и рисков
      </p>
    </div>
  ...
  <footer class="main-footer-cta">
    <div class="footer-title">Готовы открыть бизнес?</div>
  ...
  <script>
    const modalContent = [
      {
        title: "Открой бизнес с нами",
        text: "PT PMA за $1600 — регистрация, счёт, документы. Онлайн, официально, надёжно."
      },
      {
        title: "Почему EasyVisa?",
        text: "Наши юристы проводят оформление строго через госорганы. Без подставных номиналов и рисков."
      },
      {
        title: "Как подать?",
        text: "Фото паспорта, селфи и ИНН — и мы начинаем. Всё остальное берём на себя."
      },
      {
        title: "Безопасно ли это?",
        text: "Да. Ты получаешь настоящую компанию с NPWP и банковским счётом."
      },
      {
        title: "Всё под контролем",
        text: "EasyVisa — твой проводник в мир легального бизнеса на Бали. Мы всегда на связи."
      }
    ];
