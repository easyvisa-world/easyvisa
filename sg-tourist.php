...
<head>
  ...
  <title>Виза в Сингапур — EasyVisa | Онлайн оформление за $90</title>
  <meta name="description" content="Туристическая виза в Сингапур на 30 дней за $90. Только паспорт и селфи. Можно использовать для визарана.">
  <link rel="icon" href="https://easyvisa.world/wp-content/uploads/2023/12/logo2.svg_.svg">
  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://easyvisa.world/singapore">
  <meta property="og:title" content="Виза в Сингапур — EasyVisa | 30 дней, $90, без визита в посольство">
  <meta property="og:description" content="Виза в Сингапур — только паспорт и селфи. Подходит для визарана. Всё онлайн, срок — 5–7 дней.">
  ...
  <meta name="twitter:title" content="Виза в Сингапур — EasyVisa | Онлайн оформление за $90">
  <meta name="twitter:description" content="Официальная туристическая виза в Сингапур на 30 дней. Отлично для визарана из Индонезии.">
...
<div class="flex flex-col items-center w-full px-2">
  <div class="flex flex-col lg:flex-row items-center justify-center gap-6 w-full max-w-4xl mx-auto mt-8">
    ...
    <div class="relative flex-1 bg-[#191d26]/95 border-4 border-[#27ffab] rounded-2xl shadow-[0_0_40px_6px_rgba(39,255,171,0.13)] p-7 flex flex-col justify-between min-w-[320px] group cursor-pointer" id="gta-visa-banner">
      <div>
        <div class="font-gta text-3xl md:text-4xl font-extrabold text-white mb-2 leading-tight drop-shadow-[0_0_12px_#29fc94b0]">Виза Сингапур — 90 дней</div>
        <div class="text-lg md:text-xl font-semibold text-[#ffe95d] mb-4 leading-snug">
          Туристическая виза на 30 дней, быстрое оформление.
        </div>
      </div>
      ...
      <div id="gta-tooltip"
        ...
        Можно вылетать в ту же страну, откуда прилетел. К примеру сделать визаран с Бали. 
      </div>
    </div>
    <!-- КНОПКИ -->
...
<br>
  <div class="container">
    <div class="card wide" data-modal="1">
      ...
      <h2 class="text-xl font-bold mb-2">Виза в Сингапур — 30 дней официально за $90</h2>
      <p>Нужен визаран, но безвиз не позволяет вернуться в ту же страну? Сингапурская виза решает это: прилетел — улетел, снова въехал. Всё онлайн, никаких сложностей. Только фото паспорта и селфи — остальное на нас. Подходит для визарана из Индонезии.</p>
    </div>
    <div class="card" data-modal="2">
      <span class="number">2</span>
      <h2 class="text-lg font-semibold mb-1">Что входит?</h2>
      <p>
        <span style="font-size:1.3em;">✅</span> Туристическая виза в Сингапур на 30 дней<br>
        <span style="font-size:1.3em;">✅</span> Позволяет вернуться в ту же страну после визарана<br>
        <span style="font-size:1.3em;">✅</span> Оформление за 5–7 рабочих дней<br>
    ...
    <div class="card" data-modal="3">
      ...
      <p>
        ...
        3. Оплати $90 — мы сразу подаём документы<br>
        4. Через 5–7 рабочих дней виза придёт на email<br>
        5. Всё! Можешь использовать визу для визарана
      </p>
    </div>
    <div class="card" data-modal="4">
      ...
      <p>
        — Это подходит для визарана? Да, можно вернуться в ту же страну<br>
        — А если фото не подойдёт? Мы проверим и подскажем<br>
        — Всё включено? Да, $90 — без доплат<br>
        — Долго ли ждать? Обычно 5–7 дней<br>
        — Что ещё нужно? Только паспорт и селфи
      </p>
    </div>
    <div class="card" data-modal="5">
      <span class="number">5</span>
      <h2 class="text-lg font-semibold mb-1">Готовы начать?</h2>
      <p>Сингапурская виза — идеальный вариант для визарана. Без риска, без отказов, без анкет. Просто отправь фото, и через 5–7 дней у тебя будет официальная виза. Пиши — всё оформим под ключ!</p>
    </div>
  </div>
  ...
  <script>
    const modalContent = [
      {
        title: "Визаран без проблем",
        text: "Сингапурская виза на 30 дней за $90. Подходит для возвращения в ту же страну."
      },
      {
        title: "Просто и понятно",
        text: "Только паспорт и селфи. Никаких анкет и посольств. Всё делаем онлайн."
      },
      {
        title: "Как подать?",
        text: "Пиши нам, отправь фото, оплати $90 — виза будет готова через 5–7 дней."
      },
      {
        title: "Частые вопросы",
        text: "Можно использовать для визарана. Фото проверим. Цена фиксированная, без доплат."
      },
      {
        title: "Начни оформление",
        text: "Сингапур ждёт! Оформим визу под ключ — быстро, надёжно и без стресса."
      }
    ];
